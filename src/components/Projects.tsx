...
const Projects = () => {
  const projects = [
    {
      title: 'StayScape',
      description:
        'A full-stack accommodation platform with CRUD listings, Mapbox maps, Cloudinary uploads, and session-based authentication. Built with React, Node.js, and MongoDB.',
      link: 'https://stayscape-v7dj.onrender.com/listings',
      github: 'https://github.com/SumerThakur1771/StayScape',
      tech: ['React', 'Node.js', 'MongoDB', 'Mapbox', 'Cloudinary'],
      image: '/lovable-uploads/eb5dea90-7779-4f0f-8eae-f73280d2a173.png',
    ...
    },
    {
      title: 'EchoMates',
      description:
        'A Figma-designed SaaS prototype for international student networking with AI-based prompts and goal tracking. Comprehensive UX research and design.',
      link: 'https://www.figma.com/proto/ZcOYtt6E7OLUVqNIPX41us/EchoMates_Final-Exam',
      github:
        'https://www.figma.com/design/ZcOYtt6E7OLUVqNIPX41us/EchoMates_Final-Exam?node-id=79-153&t=oUw3n7Exz6qQEhhP-0',
      tech: ['Figma', 'UX Design', 'Prototyping', 'AI Integration'],
      image: '/lovable-uploads/2e1897c3-7005-4aae-90d4-593b636ca9be.png',
      type: 'mobile',
    },
  ...
  return (
    <section
      id="projects"
      className="section-padding scroll-mt-28 bg-gradient-to-b from-background via-pink-950/10 to-background"
    >
      <div className="container mx-auto">
        <div className="text-center mb-14">
          <h2 className="text-4xl md:text-5xl md:leading-normal font-bold gradient-text">
